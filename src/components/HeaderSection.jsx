  ...
  return (
    <section>
      ...
      <div className="col-span-7 place-self-center">
        <h1 className="text-white mb-4 text-4xl lg:text-6xl font-extrabold">Hello, Iam Heiday</h1>
      <p className="text-[#ADB7BE] text-lg mb-6 lg:text-xl">Welcome to my portfolio!</p>
      <div>
